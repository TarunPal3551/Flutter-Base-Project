...
class FoodItemsListState extends State<FoodItemsList> {
  ...
  void getCategoryList() {
    categoryController.getAllFoodItems().then((value) {
      if (value != null) {
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => AddOnItemsForm(itemId: null)),
            ).then((value) {
              categoryList.clear();
              getCategoryList();
            });
                    ...
                    InkWell(
                      onTap: () {
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  AddOnItemsForm(itemId: elementAt.id)),
                        ).then((value) {
                          categoryList.clear();
                          getCategoryList();
                        });
